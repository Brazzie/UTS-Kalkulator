package com.example.kalkulator_abdillah;
...
import com.example.kalkulator_abdillah.R;
        ...
        mButtonHitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mEditTextBilanganPertama.getText().toString().equals("")) {
                    mEditTextBilanganPertama.setError("Silahkan Input Bilangan Pertama");
                    return;
                }
                if (mEditTextBilanganKedua.getText().toString().equals("")) {
                    mEditTextBilanganKedua.setError("Silahkan Input Bilangan Kedua");
                    return;
                }
